...
class IQ_File_Generator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "IQ_File_Generator")
        ...
        self.blocks_head_0_0 = blocks.head(gr.sizeof_gr_complex*1, 1024)
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, 1024)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'post_channel.iq', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'pre_channel.iq', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SAW_WAVE, 1842.5e6, 1, 0, 0)
...
def main(top_block_cls=IQ_File_Generator, options=None):
